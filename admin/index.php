                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ...
                            <?php
                            $element_text = [_ADM_ALL_POSTS, _ADM_ACT_POSTS, _ADM_DRAFT_POSTS, _ADM_ALL_COMENTS, _ADM_PENDING_COMENTS, _ADM_ALL_USERS, _ADM_SUBSCRIBERS, _ADM_CATEGORIES];
